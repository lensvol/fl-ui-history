...
interface Props extends RouteComponentProps { className?: string }
    ...
    <div className={classnames('footer-content', className)}>
      ...
      <div className="">
        <ul className="list--horizontal">
          ...
          <li className="list-item--separated"><Link to="/privacy">Privacy</Link></li>
          <li className="list-item--separated"><Link to="/terms">Terms</Link></li>
          <li className="list-item--separated"><a href="http://www.twitter.com/failbettergames">FBG on Twitter</a></li>
        </ul>
      </div>
    </div>
  );
