...
import LeafletPixiOverlay from "components/Map/ReactLeafletPixiOverlay/LeafletPixiOverlay";
import redrawCallback from "components/Map/ReactLeafletPixiOverlay/redrawCallback";
...
class ReactLeafletPixiOverlay extends MapLayer {
  ...
  componentDidMount() {
    ...
    this.layerContainer.addLayer(this.leafletElement, "SelectedAreaOverlay");
