...
function PlayerMarker({
  ...
  const icon = useMemo(() => new L.Icon({
    iconAnchor,
    className: classnames('map__player-marker', isCurrentPlayerMarkerArea && 'map__player-marker--visible'),
  ...
  const position = useMemo(() => {
    ...
    if (playerMarkerAnchorX !== undefined && playerMarkerAnchorY !== undefined) {
