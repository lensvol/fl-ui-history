      ...
      {(enabled: boolean) => (
        <div>
          ...
          >
            ...
            <div>
              ...
              <div
                style={{ fontSize: '125%' }}
              >
                {renewDateAsDate.toLocaleDateString(
                  'en-gb',
                  {
                    year: 'numeric',
                    month: 'long',
          ...
          <p>
            ...
            By cancelling your subscription, you will no longer have a second action candle,
            expanded opportunity deck,
            {' '}
            {enabled ? 'two additional outfits,' : ''}
            {' '}
            or access to the House of Chimes.
            You will no longer receive a new Exceptional Story every month.
