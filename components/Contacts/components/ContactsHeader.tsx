...
export default function ContactsHeader() {
  const buttonletText = 'You can invite contacts to participate in stories with you.'
  ...
  return (
    <div style={{/* alignItems: 'center', display: 'flex ', marginBottom: '.5rem' */}}>
      <h2 className="heading heading--2 heading--no-margin-bottom">
        Contacts
      </h2>
