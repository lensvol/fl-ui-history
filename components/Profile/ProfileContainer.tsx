...
class ProfileContainer extends Component<Props> {
  ...
  render() {
    ...
    if (!profileCharacter) {
      return (
        <div>
          <Hero characterName={characterName} currentArea={currentArea} />
          <Loading spinner />
        </div>
      );
    }
    ...
    return (
      ...
      >
        <div>
          <Header />
          <Hero currentArea={currentArea} characterName={characterName} />
...
type Props = RouteComponentProps<{ profileName: string }> &
