...
export const FETCH_FEED_MESSAGES_REQUESTED =
  "messages/FETCH_FEED_MESSAGES_REQUESTED";
export const FETCH_FEED_MESSAGES_SUCCESS =
  "messages/FETCH_FEED_MESSAGES_SUCCESS";
export const FETCH_FEED_MESSAGES_FAILURE =
  "messages/FETCH_FEED_MESSAGES_FAILURE";

export const CLEAR_NOTIFICATION = "messages/CLEAR_NOTIFICATION";
export const FETCH_QUEUED = "messages/FETCH_QUEUED";
export const FETCH_INTERACTIONS_REQUESTED =
  "messages/FETCH_INTERACTIONS_REQUESTED";
