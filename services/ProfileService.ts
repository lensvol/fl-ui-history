...
export interface IProfileService {
  ...
  fetchProfile: (characterName: string, fromEchoId?: string | number) => Promise<Either<FetchProfileResponse>>,
  fetchSharedContent: (args: FetchSharedContentArgs) => Promise<Either<FetchSharedContentResponse>>,
  fetchSharedContentByUrl: (url: string) => Promise<Either<FetchSharedContentResponse>>,
  share: (
    contentClass: any,
    contentKey: any,
    image: any,
  ...
  updateDescription: (newDescription: string) => Promise<Either<UpdateDescriptionResponse>>,
}
