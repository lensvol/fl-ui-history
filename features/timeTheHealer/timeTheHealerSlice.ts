...
import SettingsService, { FetchTimeTheHealerResponse } from 'services/SettingsService';
...
const fetchTimeTheHealer = createAsyncThunk<FetchTimeTheHealerResponse, void, { state: RootState }>(
  'timeTheHealer/fetchTimeTheHealer',
  async () => {
    const response: Success<FetchTimeTheHealerResponse> | Failure = await new SettingsService().fetchTimeTheHealer();
