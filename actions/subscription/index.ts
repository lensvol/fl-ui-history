...
export const cancelBraintreeSubscriptionRequested = () => ({ type: CANCEL_BRAINTREE_SUBSCRIPTION_REQUESTED });

export const cancelBraintreeSubscriptionSuccess = (data: ICancelSubscriptionSuccessData) => ({
