...
export type DeactivateAccountRequested = {
  type: typeof SettingsActionTypes.DEACTIVATE_ACCOUNT_REQUESTED;
};
export type DeactivateAccountSuccess = {
  type: typeof SettingsActionTypes.DEACTIVATE_ACCOUNT_SUCCESS;
};
export type DeactivateAccountFailure = {
  type: typeof SettingsActionTypes.DEACTIVATE_ACCOUNT_FAILURE;
};
...
export const deactivateAccountRequested: ActionCreator<
  DeactivateAccountRequested
> = () => ({
  type: SettingsActionTypes.DEACTIVATE_ACCOUNT_REQUESTED,
});

export const deactivateAccountSuccess: ActionCreator<
  DeactivateAccountSuccess
> = (_response?: any) => ({
  type: SettingsActionTypes.DEACTIVATE_ACCOUNT_SUCCESS,
});

export const deactivateAccountFailure: ActionCreator<
  DeactivateAccountFailure
> = (_error?: any) => ({
