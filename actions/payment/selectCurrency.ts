...
type SelectCurrencyRequested = {
  type: typeof SELECT_CURRENCY_REQUESTED;
...
export const selectCurrencyRequested: ActionCreator<SelectCurrencyRequested> = (
  currencyCode: string
) => ({
...
export const selectCurrencyFailure: ActionCreator<SelectCurrencyFailure> = (
  error: any
) => ({
