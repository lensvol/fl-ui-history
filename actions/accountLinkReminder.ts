...
export type ShowAccountLinkReminder = {
  type: typeof SHOW_ACCOUNT_LINK_REMINDER;
};
export type HideAccountLinkReminder = {
  type: typeof HIDE_ACCOUNT_LINK_REMINDER;
};
...
export const hideAccountLinkReminder: ActionCreator<
  HideAccountLinkReminder
> = () => ({
