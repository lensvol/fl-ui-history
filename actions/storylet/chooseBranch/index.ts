...
import chooseBranchFailure, { ChooseBranchFailureAction } from './chooseBranchFailure';
import chooseBranchRequest, { ChooseBranchRequestedAction } from './chooseBranchRequest';
import chooseBranchSuccess, { ChooseBranchSuccessAction } from './chooseBranchSuccess';

export type ChooseBranchAction = ChooseBranchFailureAction | ChooseBranchRequestedAction | ChooseBranchSuccessAction;
