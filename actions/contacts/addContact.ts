...
export const addContactRequested: ActionCreator<AddContactRequested> = () => ({
  type: ADD_CONTACT_REQUESTED,
});

export const addContactSuccess: ActionCreator<AddContactSuccess> = (
  data: AddContactResponseData
) => ({
...
export const addContactFailure: ActionCreator<AddContactFailure> = (
  error: any
) => ({
