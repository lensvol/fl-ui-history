...
export type ChooseNewMantelpieceRequested = {
  type: typeof CHOOSE_NEW_MANTELPIECE_REQUESTED;
};
export type ChooseNewMantelpieceSuccess = ChooseNewDisplayQualitySuccess<
  typeof CHOOSE_NEW_MANTELPIECE_SUCCESS
>;

export type ChooseNewMantelpieceFailure = {
  type: typeof CHOOSE_NEW_MANTELPIECE_FAILURE;
};
...
const chooseNewMantelpieceRequested: ActionCreator<
  ChooseNewMantelpieceRequested
> = () => ({
  type: CHOOSE_NEW_MANTELPIECE_REQUESTED,
});

const chooseNewMantelpieceSuccess: ActionCreator<
  ChooseNewMantelpieceSuccess
> = (data: IQuality) => ({
