...
export default function processStandardMessages(standardMessages: ApiResultMessageQualityEffect[]) {
...
function hasPossession(x: { possession?: IQuality | undefined }): x is HasPossessionQuality {
