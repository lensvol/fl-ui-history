...
export const discardSuccess: ActionCreator<DiscardCardsSuccess> = (
  data: DiscardCardResponse
) => ({
  type: DISCARD_CARDS_SUCCESS,
  payload: data,
});

export const discardFailure: ActionCreator<DiscardCardsFailure> = (
  error: any
) => ({
...
export function discard(
  ...
  return (eventId: number) =>
    async (dispatch: ThunkDispatch<Either<DiscardCardResponse>, any, any>) => {
