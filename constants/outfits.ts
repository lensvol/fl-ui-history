...
export const OUTFIT_CATEGORIES = [...STANDARD_CATEGORIES, ...EXPANDED_CATEGORIES];

export const MESSAGE_LAPSED_EXCEPTIONAL_OUTFIT = 'You cannot put this outfit on unless you are an Exceptional Friend.';