...
const isExcluded = (quality: IQuality) => EXCLUDED_QUALITY_IDS.indexOf(quality.id) >= 0;
...
export function getMatchingQualities(qualities: IQuality[]): (ids: number[]) => IQuality[] {
...
export default createCachedSelector(getFilterString, getQualities, getQualityIds, outputFn)(cacheKey);